 ...
 implements DRMSServices.LibraryInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  /**
       ...
       case 4:  // DRMSServices/LibraryInterface/setDuration
       {
         ...
         int days = in.read_long ();
         boolean $result = false;
         $result = this.setDuration (username, bookName, authorName, days);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
  ...
  /**
  		 ...
  		 */
       case 6:  // DRMSServices/LibraryInterface/setUdpPort
       {
  ...
  /**
  		 ...
  		 */
       case 7:  // DRMSServices/LibraryInterface/setByzantineFlag
       {
