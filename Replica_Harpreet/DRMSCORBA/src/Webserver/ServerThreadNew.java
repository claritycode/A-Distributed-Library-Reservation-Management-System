...
{
	DRMSServer server;// The object of the  Server is made so as to invoke the UDP Functions on it
	...
	*/
	public ServerThreadNew(DRMSServer server, DatagramPacket request)
	{
		 ...
		 if(new String(request.getData()).contains(" "))
		    {
			 	...
			 	{
			 		System.out.println("in the thread of the DRMS Server");
		    ...
		    String _instituteName="Concordia";
...
*/
			    	...
			    	System.out.println(nonreturners+"in the THREAD of Concordia");
